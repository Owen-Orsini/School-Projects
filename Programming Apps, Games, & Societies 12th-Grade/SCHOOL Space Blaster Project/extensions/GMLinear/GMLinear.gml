...
#define r2_clone_to
/// @description r2_clone_to(v, vout)
/// @param v
/// @param vout
{
...
#define r2_add_to
/// @description r2_add_to(v1, v2, vout)
/// @param v1
/// @param v2
/// @param vout
{
...
/// @description r2_subtract_to(v1, v2, vout)
/// @param v1
/// @param v2
/// @param vout
{
...
#define r2_scale_to
/// @description r2_scale_to(v, r, vout)
/// @param v
/// @param r
/// @param vout
{
...
#define r2_unit
/// @description r2_unit(v)
/// @param v
{
 var result = array_create(2, 0);
...
#define r2_lerp
/// @description r2_lerp(v1, v2, amount)
/// @param v1
/// @param v2
/// @param amount
{
...
#define r2_lerp_to
/// @description r2_lerp_to(v1, v2, amount, vout)
/// @param v1
/// @param v2
/// @param amount
/// @param vout
...
#define r2_proj_to
/// @description r2_proj_to(v1, v2, vout)
/// @param v1
/// @param v2
/// @param vout
{
...
#define r2_rej_to
/// @description r2_rej_to(v1, v2, vout)
/// @param v1
/// @param v2
/// @param vout
{
...
/// @description r2_encode_string(v)
/// @param v
{
...
/// @description r2_decode_string(str)
/// @param str
{
  var str, pos, result;
  str = argument0;
...
/// @description r2_decode_string_to(str, vout)
/// @param str
/// @param vout
{
  var str, pos;
...
/// @description r2_encode_base64(v)
/// @param v
{
...
/// @description r2_decode_base64(enc)
/// @param enc
{
  var buffer = buffer_create(16, buffer_fixed, 1);
...
/// @description r2_decode_base64_to(enc, vout)
/// @param enc
/// @param vout
{
  var buffer = buffer_create(16, buffer_fixed, 1);
...
/// @description r2_rec_gmp_to(vi_xy, vo_ld)
/// @param vi_xy
/// @param vo_ld
{
  var xx = argument0[0],
...
/// @description r2_gmp_rec_to(vi_ld, vo_xy)
/// @param vi_ld
/// @param vo_xy
{
  var len = argument0[0],
...
/// @description r2_rec_pol_to(vi_xy, vo_rt)
/// @param vi_xy
/// @param vo_rt
{
  var xx = argument0[0],
...
/// @description r2_pol_rec_to(vi_rt, vo_xy)
/// @param vi_rt
/// @param vo_xy
{
  var r = argument0[0],
...
/// @description r2_gmp_pol_to(vi_ld, vo_rt)
/// @param vi_ld
/// @param vo_rt
{
  argument1[@ 0] = argument0[0];
...
/// @description r2_pol_gmp_to(vi_rt, vo_ld)
/// @param vi_rt
/// @param vo_ld
{
  argument1[@ 0] = argument0[0];
...
#define r3_clone_to
/// @description r3_clone_to(v, vout)
/// @param v
/// @param vout
{
  argument1[@ 0] = argument0[0];
...
#define r3_add_to
/// @description r3_add_to(v1, v2, vout)
/// @param v1
/// @param v2
/// @param vout
{
...
/// @description r3_subtract_to(v1, v2, vout)
/// @param v1
/// @param v2
/// @param vout
{
...
#define r3_cross_to
/// @description r3_cross_to(v1, v2, vout)
/// @param v1
/// @param v2
/// @param vout
{
...
#define r3_scale_to
/// @description r3_scale_to(v, r, vout)
/// @param v
/// @param r
/// @param vout
{
...
#define r3_lerp
/// @description r3_lerp(v1, v2, amount)
/// @param v1
/// @param v2
/// @param amount
{
...
#define r3_lerp_to
/// @description r3_lerp_to(v1, v2, amount, vout)
/// @param v1
/// @param v2
/// @param amount
/// @param vout
...
#define r3_proj_to
/// @description r3_proj_to(v1, v2, vout)
/// @param v1
/// @param v2
/// @param vout
{
...
#define r3_rej_to
/// @description r3_rej_to(v1, v2, vout)
/// @param v1
/// @param v2
/// @param vout
{
...
/// @description r3_encode_string(v)
/// @param v
{
...
/// @description r3_decode_string(str)
/// @param str
{
  var str, pos, result;
  str = argument0;
...
/// @description r3_decode_string_to(str, vout)
/// @param str
/// @param vout
{
  var str, pos;
...
/// @description r3_encode_base64(v)
/// @param v
{
...
/// @description r3_decode_base64(enc)
/// @param enc
{
  var buffer = buffer_create(24, buffer_fixed, 1);
  buffer_base64_decode_ext(buffer, argument0, 0);
...
/// @description r3_decode_base64_to(enc, vout)
/// @param enc
/// @param vout
{
  var buffer = buffer_create(24, buffer_fixed, 1);
...
/// @description r4_encode_string(v)
/// @param v
{
...
/// @description r4_decode_string(str)
/// @param str
{
  var str, pos, result;
  str = argument0;
...
/// @description r4_decode_string_to(str, vout)
/// @param str
/// @param vout
{
  var str, pos;
...
/// @description r4_encode_base64(v)
/// @param v
{
...
/// @description r4_decode_base64(enc)
/// @param enc
{
  var buffer = buffer_create(32, buffer_fixed, 1);
  buffer_base64_decode_ext(buffer, argument0, 0);
...
/// @description r4_decode_base64_to(enc, vout)
/// @param enc
/// @param vout
{
  var buffer = buffer_create(32, buffer_fixed, 1);
